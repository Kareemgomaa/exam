...
courseRouter.post('/create-course',auth, allowedRoles(["teacher"]), validate(courseSchema), creatCourse);
courseRouter.get('/courses/search', courseSearch)
courseRouter.get('/course-by-id/:id', getCourseById)
courseRouter.patch('/edit-course/:id', auth, allowedRoles(["teacher"]), validate(courseSchema), editing)
courseRouter.delete('/delete-course/:id', auth, allowedRoles(["teacher"]), deleteCourse)
courseRouter.get('/get-teacher-courses',auth , allowedRoles(["teacher"]), ownCourses)
